...
class BrickletCurrent12(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletCurrent12.FUNCTION_GET_CURRENT] = 1
        self.response_expected[BrickletCurrent12.FUNCTION_CALIBRATE] = 4
        self.response_expected[BrickletCurrent12.FUNCTION_IS_OVER_CURRENT] = 1
        self.response_expected[BrickletCurrent12.FUNCTION_GET_ANALOG_VALUE] = 1
        self.response_expected[BrickletCurrent12.FUNCTION_SET_CURRENT_CALLBACK_PERIOD] = 4
        self.response_expected[BrickletCurrent12.FUNCTION_GET_CURRENT_CALLBACK_PERIOD] = 1
        self.response_expected[BrickletCurrent12.FUNCTION_SET_ANALOG_VALUE_CALLBACK_PERIOD] = 4
        self.response_expected[BrickletCurrent12.FUNCTION_GET_ANALOG_VALUE_CALLBACK_PERIOD] = 1
        self.response_expected[BrickletCurrent12.FUNCTION_SET_CURRENT_CALLBACK_THRESHOLD] = 4
        self.response_expected[BrickletCurrent12.FUNCTION_GET_CURRENT_CALLBACK_THRESHOLD] = 1
        self.response_expected[BrickletCurrent12.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD] = 4
        self.response_expected[BrickletCurrent12.FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD] = 1
        self.response_expected[BrickletCurrent12.FUNCTION_SET_DEBOUNCE_PERIOD] = 4
        self.response_expected[BrickletCurrent12.FUNCTION_GET_DEBOUNCE_PERIOD] = 1
        self.response_expected[BrickletCurrent12.CALLBACK_CURRENT] = 2
        self.response_expected[BrickletCurrent12.CALLBACK_ANALOG_VALUE] = 2
        self.response_expected[BrickletCurrent12.CALLBACK_CURRENT_REACHED] = 2
        self.response_expected[BrickletCurrent12.CALLBACK_ANALOG_VALUE_REACHED] = 2
        self.response_expected[BrickletCurrent12.CALLBACK_OVER_CURRENT] = 2
        self.response_expected[BrickletCurrent12.FUNCTION_GET_IDENTITY] = 1
