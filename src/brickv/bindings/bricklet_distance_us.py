...
class BrickletDistanceUS(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletDistanceUS.FUNCTION_GET_ANALOG_VALUE_CALLBACK_PERIOD] = BrickletDistanceUS.RESPONSE_EXPECTED_ALWAYS_TRUE
        ...
        self.response_expected[BrickletDistanceUS.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD] = BrickletDistanceUS.RESPONSE_EXPECTED_TRUE
        self.response_expected[BrickletDistanceUS.FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD] = BrickletDistanceUS.RESPONSE_EXPECTED_ALWAYS_TRUE
        ...
        self.response_expected[BrickletDistanceUS.CALLBACK_ANALOG_VALUE] = BrickletDistanceUS.RESPONSE_EXPECTED_ALWAYS_FALSE
        self.response_expected[BrickletDistanceUS.CALLBACK_DISTANCE_REACHED] = BrickletDistanceUS.RESPONSE_EXPECTED_ALWAYS_FALSE
        self.response_expected[BrickletDistanceUS.CALLBACK_ANALOG_VALUE_REACHED] = BrickletDistanceUS.RESPONSE_EXPECTED_ALWAYS_FALSE
        ...
        self.callback_formats[BrickletDistanceUS.CALLBACK_ANALOG_VALUE] = 'H'
        self.callback_formats[BrickletDistanceUS.CALLBACK_DISTANCE_REACHED] = 'H'
        self.callback_formats[BrickletDistanceUS.CALLBACK_ANALOG_VALUE_REACHED] = 'H'
    ...
    def get_distance(self):
        ...
        """
        return self.ipcon.send_request(self, BrickletDistanceUS.FUNCTION_GET_DISTANCE, (), '', 'H')
    ...
    def set_analog_value_callback_period(self, period):
        ...
        The default value is 0.
        """
        self.ipcon.send_request(self, BrickletDistanceUS.FUNCTION_SET_ANALOG_VALUE_CALLBACK_PERIOD, (period,), 'I', '')

    def get_analog_value_callback_period(self):
        """
        Returns the period as set by :func:`SetAnalogValueCallbackPeriod`.
        """
        return self.ipcon.send_request(self, BrickletDistanceUS.FUNCTION_GET_ANALOG_VALUE_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_analog_value_callback_threshold(self, option, min, max):
        ...
        The default value is ('x', 0, 0).
        """
        self.ipcon.send_request(self, BrickletDistanceUS.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD, (option, min, max), 'c H H', '')

    def get_analog_value_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetAnalogValueCallbackThreshold`.
        """
        return GetAnalogValueCallbackThreshold(*self.ipcon.send_request(self, BrickletDistanceUS.FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD, (), '', 'c H H'))
