...
class BrickletLCD16x2(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletLCD16x2.FUNCTION_WRITE_LINE] = 4
        self.response_expected[BrickletLCD16x2.FUNCTION_CLEAR_DISPLAY] = 4
        self.response_expected[BrickletLCD16x2.FUNCTION_BACKLIGHT_ON] = 4
        self.response_expected[BrickletLCD16x2.FUNCTION_BACKLIGHT_OFF] = 4
        self.response_expected[BrickletLCD16x2.FUNCTION_IS_BACKLIGHT_ON] = 1
        self.response_expected[BrickletLCD16x2.FUNCTION_SET_CONFIG] = 4
        self.response_expected[BrickletLCD16x2.FUNCTION_GET_CONFIG] = 1
        self.response_expected[BrickletLCD16x2.FUNCTION_IS_BUTTON_PRESSED] = 1
        self.response_expected[BrickletLCD16x2.CALLBACK_BUTTON_PRESSED] = 2
        self.response_expected[BrickletLCD16x2.CALLBACK_BUTTON_RELEASED] = 2
        self.response_expected[BrickletLCD16x2.FUNCTION_GET_IDENTITY] = 1
