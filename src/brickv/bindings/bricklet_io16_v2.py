...
class BrickletIO16V2(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletIO16V2.FUNCTION_GET_SELECTED_VALUE] = BrickletIO16V2.RESPONSE_EXPECTED_ALWAYS_TRUE
    ...
    def get_selected_value(self, channel):
        ...
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_SELECTED_VALUE, (channel,), 'B', '!')
