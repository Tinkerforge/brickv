...
class Voltage(Device):
    ...
    def get_voltage(self):
        ...
        """
        return self.ipcon.write(self, Voltage.FUNCTION_GET_VOLTAGE, (), '', 'H')
    ...
    def get_analog_value(self):
        ...
        """
        return self.ipcon.write(self, Voltage.FUNCTION_GET_ANALOG_VALUE, (), '', 'H')
    ...
    def set_voltage_callback_period(self, period):
        ...
        """
        self.ipcon.write(self, Voltage.FUNCTION_SET_VOLTAGE_CALLBACK_PERIOD, (period,), 'I', '')

    def get_voltage_callback_period(self):
        """
        Returns the period as set by :func:`SetVoltageCallbackPeriod`.
        """
        return self.ipcon.write(self, Voltage.FUNCTION_GET_VOLTAGE_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_analog_value_callback_period(self, period):
        ...
        The default value is 0.
        """
        self.ipcon.write(self, Voltage.FUNCTION_SET_ANALOG_VALUE_CALLBACK_PERIOD, (period,), 'I', '')

    def get_analog_value_callback_period(self):
        """
        Returns the period as set by :func:`SetAnalogValueCallbackPeriod`.
        """
        return self.ipcon.write(self, Voltage.FUNCTION_GET_ANALOG_VALUE_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_voltage_callback_threshold(self, option, min, max):
        ...
        """
        self.ipcon.write(self, Voltage.FUNCTION_SET_VOLTAGE_CALLBACK_THRESHOLD, (option, min, max), 'c h h', '')

    def get_voltage_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetVoltageCallbackThreshold`.
        """
        return GetVoltageCallbackThreshold(*self.ipcon.write(self, Voltage.FUNCTION_GET_VOLTAGE_CALLBACK_THRESHOLD, (), '', 'c h h'))
    ...
    def set_analog_value_callback_threshold(self, option, min, max):
        ...
        The default value is ('x', 0, 0).
        """
        self.ipcon.write(self, Voltage.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD, (option, min, max), 'c H H', '')

    def get_analog_value_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetAnalogValueCallbackThreshold`.
        """
        return GetAnalogValueCallbackThreshold(*self.ipcon.write(self, Voltage.FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD, (), '', 'c H H'))
    ...
    def set_debounce_period(self, debounce):
        ...
        """
        self.ipcon.write(self, Voltage.FUNCTION_SET_DEBOUNCE_PERIOD, (debounce,), 'I', '')

    def get_debounce_period(self):
        """
        Returns the debounce period as set by :func:`SetDebouncePeriod`.
        """
        return self.ipcon.write(self, Voltage.FUNCTION_GET_DEBOUNCE_PERIOD, (), '', 'I')
