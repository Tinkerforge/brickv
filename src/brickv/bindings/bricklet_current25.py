...
class Current25(Device):
    ...
    def __init__(self, uid):
        ...
        self.callbacks_format[Current25.CALLBACK_CURRENT] = 'h'
        self.callbacks_format[Current25.CALLBACK_ANALOG_VALUE] = 'H'
        self.callbacks_format[Current25.CALLBACK_CURRENT_REACHED] = 'h'
        self.callbacks_format[Current25.CALLBACK_ANALOG_VALUE_REACHED] = 'H'
        self.callbacks_format[Current25.CALLBACK_OVER_CURRENT] = ''
    ...
    def get_current(self):
        ...
        """
        return self.ipcon.write(self, Current25.FUNCTION_GET_CURRENT, (), '', 'h')
    ...
    def calibrate(self):
        ...
        Bricklet.
        """
        self.ipcon.write(self, Current25.FUNCTION_CALIBRATE, (), '', '')
    ...
    def is_over_current(self):
        ...
        """
        return self.ipcon.write(self, Current25.FUNCTION_IS_OVER_CURRENT, (), '', '?')
    ...
    def get_analog_value(self):
        ...
        """
        return self.ipcon.write(self, Current25.FUNCTION_GET_ANALOG_VALUE, (), '', 'H')
    ...
    def set_current_callback_period(self, period):
        ...
        """
        self.ipcon.write(self, Current25.FUNCTION_SET_CURRENT_CALLBACK_PERIOD, (period,), 'I', '')

    def get_current_callback_period(self):
        """
        Returns the period as set by :func:`SetCurrentCallbackPeriod`.
        """
        return self.ipcon.write(self, Current25.FUNCTION_GET_CURRENT_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_analog_value_callback_period(self, period):
        ...
        The default value is 0.
        """
        self.ipcon.write(self, Current25.FUNCTION_SET_ANALOG_VALUE_CALLBACK_PERIOD, (period,), 'I', '')

    def get_analog_value_callback_period(self):
        """
        Returns the period as set by :func:`SetAnalogValueCallbackPeriod`.
        """
        return self.ipcon.write(self, Current25.FUNCTION_GET_ANALOG_VALUE_CALLBACK_PERIOD, (), '', 'I')
    ...
    def set_current_callback_threshold(self, option, min, max):
        ...
        """
        self.ipcon.write(self, Current25.FUNCTION_SET_CURRENT_CALLBACK_THRESHOLD, (option, min, max), 'c h h', '')

    def get_current_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetCurrentCallbackThreshold`.
        """
        return GetCurrentCallbackThreshold(*self.ipcon.write(self, Current25.FUNCTION_GET_CURRENT_CALLBACK_THRESHOLD, (), '', 'c h h'))
    ...
    def set_analog_value_callback_threshold(self, option, min, max):
        ...
        The default value is ('x', 0, 0).
        """
        self.ipcon.write(self, Current25.FUNCTION_SET_ANALOG_VALUE_CALLBACK_THRESHOLD, (option, min, max), 'c H H', '')

    def get_analog_value_callback_threshold(self):
        """
        Returns the threshold as set by :func:`SetAnalogValueCallbackThreshold`.
        """
        return GetAnalogValueCallbackThreshold(*self.ipcon.write(self, Current25.FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD, (), '', 'c H H'))
    ...
    def set_debounce_period(self, debounce):
        ...
        """
        self.ipcon.write(self, Current25.FUNCTION_SET_DEBOUNCE_PERIOD, (debounce,), 'I', '')

    def get_debounce_period(self):
        """
        Returns the debounce period as set by :func:`SetDebouncePeriod`.
        """
        return self.ipcon.write(self, Current25.FUNCTION_GET_DEBOUNCE_PERIOD, (), '', 'I')
