...
class Barometer(PluginBase):
    def __init__(self, *args):
        ...
        self.air_pressure_plot_widget = PlotWidget('Air Pressure [hPa]', plots, clear_button=self.clear_graphs_button, y_resolution=0.001)

        plots = [('Altitude', Qt.darkGreen, self.current_altitude, lambda value: '{:.2f} m ({:.2f} ft)'.format(value, value / METER_TO_FEET_DIVISOR))]
        self.altitude_plot_widget = PlotWidget('Altitude [m]', plots, clear_button=self.clear_graphs_button, y_resolution=0.01)
