...
class LinearPoti(Device):
    ...
    def get_position(self):
        return self.ipcon.write(self, LinearPoti.TYPE_GET_POSITION, (), '', 'H')

    def get_analog_value(self):
        return self.ipcon.write(self, LinearPoti.TYPE_GET_ANALOG_VALUE, (), '', 'H')

    def set_position_callback_period(self, period):
        self.ipcon.write(self, LinearPoti.TYPE_SET_POSITION_CALLBACK_PERIOD, (period,), 'I', '')

    def get_position_callback_period(self):
        return self.ipcon.write(self, LinearPoti.TYPE_GET_POSITION_CALLBACK_PERIOD, (), '', 'I')

    def set_analog_value_callback_period(self, period):
        self.ipcon.write(self, LinearPoti.TYPE_SET_ANALOG_VALUE_CALLBACK_PERIOD, (period,), 'I', '')

    def get_analog_value_callback_period(self):
        return self.ipcon.write(self, LinearPoti.TYPE_GET_ANALOG_VALUE_CALLBACK_PERIOD, (), '', 'I')

    def set_position_callback_threshold(self, option, min, max):
        self.ipcon.write(self, LinearPoti.TYPE_SET_POSITION_CALLBACK_THRESHOLD, (option, min, max), 'c h h', '')

    def get_position_callback_threshold(self):
        return GetPositionCallbackThreshold(*self.ipcon.write(self, LinearPoti.TYPE_GET_POSITION_CALLBACK_THRESHOLD, (), '', 'c h h'))

    def set_analog_value_callback_threshold(self, option, min, max):
        self.ipcon.write(self, LinearPoti.TYPE_SET_ANALOG_VALUE_CALLBACK_THRESHOLD, (option, min, max), 'c H H', '')

    def get_analog_value_callback_threshold(self):
        return GetAnalogValueCallbackThreshold(*self.ipcon.write(self, LinearPoti.TYPE_GET_ANALOG_VALUE_CALLBACK_THRESHOLD, (), '', 'c H H'))

    def set_debounce_period(self, debounce):
        self.ipcon.write(self, LinearPoti.TYPE_SET_DEBOUNCE_PERIOD, (debounce,), 'I', '')

    def get_debounce_period(self):
        return self.ipcon.write(self, LinearPoti.TYPE_GET_DEBOUNCE_PERIOD, (), '', 'I')
