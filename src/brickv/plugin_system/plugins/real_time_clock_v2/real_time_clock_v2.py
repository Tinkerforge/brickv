...
from brickv.plugin_system.plugins.real_time_clock_v2.ui_real_time_clock_v2 import Ui_RealTimeClockV2
from brickv.plugin_system.plugins.real_time_clock_v2.ui_calibration import Ui_Calibration
...
WEEKDAY_BY_NAME = {
    'Monday' : BrickletRealTimeClockV2.WEEKDAY_MONDAY,
    'Tuesday' : BrickletRealTimeClockV2.WEEKDAY_TUESDAY,
    'Wednesday' : BrickletRealTimeClockV2.WEEKDAY_WEDNESDAY,
    'Thursday' : BrickletRealTimeClockV2.WEEKDAY_THURSDAY,
    'Friday' : BrickletRealTimeClockV2.WEEKDAY_FRIDAY,
    'Saturday' : BrickletRealTimeClockV2.WEEKDAY_SATURDAY,
    'Sunday' : BrickletRealTimeClockV2.WEEKDAY_SUNDAY,
}

WEEKDAY_BY_NUMBER = {
    BrickletRealTimeClockV2.WEEKDAY_MONDAY : 'Monday',
    BrickletRealTimeClockV2.WEEKDAY_TUESDAY : 'Tuesday',
    BrickletRealTimeClockV2.WEEKDAY_WEDNESDAY : 'Wednesday',
    BrickletRealTimeClockV2.WEEKDAY_THURSDAY : 'Thursday',
    BrickletRealTimeClockV2.WEEKDAY_FRIDAY : 'Friday',
    BrickletRealTimeClockV2.WEEKDAY_SATURDAY : 'Saturday',
    BrickletRealTimeClockV2.WEEKDAY_SUNDAY : 'Sunday',
}
...
class RealTimeClockV2(COMCUPluginBase, Ui_RealTimeClockV2):
    ...
    def has_device_identifier(device_identifier):
        return device_identifier == BrickletRealTimeClockV2.DEVICE_IDENTIFIER
    ...
    def cb_date_time(self, year, month, day, hour, minute, second, centisecond, weekday, _timestamp):
