...
#            rainbow.append((r, g, b))
    ...
    def new_image_data(self, data, is_16bit = False):
    ...
    def paintEvent(self, event):
        ...
        if self.agc_roi_from != None and self.agc_roi_to != None:
            pen = QPen()
...
class ThermalImaging(COMCUPluginBase, Ui_ThermalImaging):
    qtcb_high_contrast_image = pyqtSignal(int, tuple)
    qtcb_temperature_image = pyqtSignal(int, tuple)
    ...
    def __init__(self, *args):
        ...
        self.qtcb_high_contrast_image.connect(self.cb_qtcb_high_contrast_image)
        self.qtcb_temperature_image.connect(self.cb_qtcb_temperature_image)
    ...
    def cb_qtcb_high_contrast_image(self, error, data):
        if error == 0:
    ...
    def cb_qtcb_temperature_image(self, error, data):
        if error == 0:
