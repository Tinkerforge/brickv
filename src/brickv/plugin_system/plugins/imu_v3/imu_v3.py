...
from brickv.plugin_system.plugins.imu_v3.imu_v3_3d_widget import IMUV33DWidget
from brickv.plugin_system.plugins.imu_v3.ui_imu_v3 import Ui_IMUV3
from brickv.plugin_system.plugins.imu_v3.ui_calibration import Ui_Calibration
...
class IMUV3(COMCUPluginBase, Ui_IMUV3):
    ...
    def start(self):
        ...
        self.parent().add_callback_on_untab(lambda x: self.cleanup_gl(), 'imu_v3_cleanup_on_untab')
        self.parent().add_callback_post_untab(lambda x: self.restart_gl(), 'imu_v3_restart_post_untab')
        self.parent().add_callback_on_tab(lambda x: self.cleanup_gl(), 'imu_v3_cleanup_on_tab')
        self.parent().add_callback_post_tab(lambda x: self.restart_gl(), 'imu_v3_restart_post_tab')
