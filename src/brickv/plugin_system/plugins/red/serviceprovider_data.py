              ...
              'provider': [{'gsm': {'apn': [{'@value': 'internet',
                           ...
                           {'gsm': {'apn': [{'@value': 'internet',
                                            ...
                                            {'@value': 'mms',
                                             ...
                                             'name': 'Airtel MMS',
                                             'usage': {'@type': 'mms'}}],
                                    'balance-check': {'ussd': '*778#'},
                                    'balance-top-up': {'ussd': {'#text': '*787*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'msisdn-query': {'ussd': '*121*6*3#'},
                                    'network-id': {'@mcc': '470',
                                                   '@mnc': '07'}},
                            'name': 'Airtel (Warid)'},
                           {'gsm': {'apn': [{'@value': 'wap',
