...
{'@format': '2.0',
 'country': [{'@code': 'ad',
             ...
             {'@code': 'ao',
              'name': 'Angola',
              'provider': [{'cdma': {'username': 'uname'}, 'name': 'Movinet'},
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'gprs.personal.com',
                           ...
                           {'gsm': {'apn': [{'@value': 'arnet.personal.com',
                                    ...
                                    'network-id': {'@mcc': '722',
                                                   '@mnc': '340'}},
                            'name': 'Arnet'},
                           {'gsm': {'apn': [{'@value': 'igprs.claro.com.ar',
                                             'name': 'Claro AR',
                                             'password': None,
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'},
                           ...
                           {'gsm': {'apn': [{'@value': 'internet.gprs.unifon.com.ar',
                            ...
                            'name': 'Movistar'}]},
             {'@code': 'at',
              'emergency-numbers': {'emergency-number': {'@number': '112',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'a1.net',
                           ...
                           {'gsm': {'apn': [{'@value': 'webaut',
                                    ...
                                    'network-id': {'@mcc': '232',
                                                   '@mnc': '07'}},
                            'name': 'HoT'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.at',
                                            'mmsc': 'http://lyca.mmsmvno.com/mms/wapenc',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmat'},
                                    'balance-check': {'ussd': '*231#'},
                                    'balance-top-up': {'ussd': {'#text': '*231*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '232',
                                                   '@mnc': '08'}},
                            'name': 'Lycamobile'},
             ...
             {'@code': 'au',
              'name': 'Australia',
              'provider': [{'gsm': {'apn': {'@value': 'mdata.net.au',
                           ...
                           {'gsm': {'apn': [{'@value': 'splns888a1',
                                             'name': 'BLiNK (services after '
                                                     '04/08/09)'},
                                            {'@value': 'connect',
                                             'name': 'BLiNK (services prior to '
                                                     '04/08/09)'}],
                                    'network-id': {'@mcc': '505',
                                                   '@mnc': '02'}},
                            'name': 'BLiNK'},
                           ...
                           {'gsm': {'apn': [{'@value': 'exetel1',
                                             'name': 'Exetel (Optus Based HSPA '
                                                     'plans)'},
                                            {'@value': 'INTERNET',
                                             'name': 'Exetel (Optus Based CAP '
                                                     'Plans) not iPhone'},
                                            {'@value': 'OPTUSWAP',
                                             'name': 'Exetel (Optus Based CAP '
                                                     'Plans) not iPhone'},
                           ...
                           {'gsm': {'apn': {'@value': 'primuslns1'},
                                    'network-id': {'@mcc': '505',
                                                   '@mnc': '02'}},
                            'name': 'iPrimus'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.com.au',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmau'},
                                    'balance-check': {'ussd': '*131#'},
                                    'balance-top-up': {'ussd': {'#text': '*131*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '505',
                                                   '@mnc': '19'}},
                            'name': 'Lycamobile'},
                           ...
                           {'gsm': {'apn': [{'@value': 'vfinternet.au',
                                    ...
                                    'visual-voicemail': {'carrier-prefix': '//VVM',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'internet',
                           ...
                           {'gsm': {'apn': [{'@value': 'internet',
                                            ...
                                            {'@value': 'mms',
                                             ...
                                             'name': 'Airtel MMS',
                                             'usage': {'@type': 'mms'}}],
                                    'balance-check': {'ussd': '*1#'},
                                    'balance-top-up': {'ussd': {'#text': '*787*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'msisdn-query': {'ussd': '*2#'},
                                    'network-id': {'@mcc': '470',
                                                   '@mnc': '07'}},
                           ...
                           {'gsm': {'apn': [{'@value': 'wap',
                                            ...
                                            {'@value': 'mms',
                                             ...
                                             'name': 'Teletalk MMS',
                                             'usage': {'@type': 'mms'}}],
                                    'balance-check': {'ussd': '*152#'},
                                    'balance-top-up': {'ussd': {'#text': '#151*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'msisdn-query': {'ussd': '*551#'},
                                    'network-id': {'@mcc': '470',
                                                   '@mnc': '04'}},
                            'name': 'Teletalk'}]},
             {'@code': 'be',
              'emergency-numbers': {'emergency-number': {'@number': '112',
                                                         'callee': [{'@type': 'ambulance'},
                                                                    ...
                                                                    {'@type': 'fire-brigade'}]}},
              'name': 'Belgium',
              'provider': [{'gsm': {'apn': {'@value': 'data.lycamobile.be',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmbe'},
                                    'balance-check': {'ussd': '*103#'},
                                    'balance-top-up': {'ussd': {'#text': '*103*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '206',
                                                   '@mnc': '06'}},
                            'name': 'Lycamobile'},
                           {'gsm': {'apn': [{'@value': 'web.pro.be',
                                             'dns': ['212.65.63.10',
                                                     '212.65.63.145'],
                                             'name': 'Business',
                                             'password': 'mobistar',
             ...
             {'@code': 'bs',
              'name': 'Bahamas',
              'provider': [{'gsm': {'apn': {'@value': 'pda.newcomobile.com',
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '364',
                                                   '@mnc': '49'}},
                            'name': 'Aliv'},
                           {'gsm': {'apn': {'@value': 'internet.btcbahamas.com',
                                            'plan': {'@type': 'postpaid'},
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '364',
                                                   '@mnc': '390'}},
             ...
             {'@code': 'bm',
              'name': 'Bermuda',
              'provider': {'gsm': {'apn': {'@value': 'web.c1.bm',
                                           'usage': {'@type': 'internet'}},
                                   'network-id': {'@mcc': '350', '@mnc': '00'}},
                           'name': 'CellOne'}},
             {'@code': 'bn',
              'name': 'Brunei',
             ...
             {'@code': 'bw',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'internet.mascom',
                           ...
                           {'gsm': {'apn': {'@value': 'internet.orange.co.bw',
                                            'plan': {'@type': 'postpaid'},
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '652',
                                                   '@mnc': '02'}},
             ...
             {'@code': 'ca',
              'name': 'Canada',
              'provider': [{'gsm': {'apn': [{'@value': 'ltemobile.apn',
                                             'dns': ['204.92.15.211',
                                                     '207.181.101.4'],
                                             'password': None,
                                             'plan': {'@type': 'postpaid'},
                           ...
                           {'gsm': {'apn': [{'@value': 'media.videotron',
                                    ...
                                    'network-id': [{'@mcc': '302',
                                                   ...
                                                   {'@mcc': '302',
                                                    '@mnc': '510'}]},
                            'name': 'Vidéotron'},
                           {'gsm': {'apn': [{'@value': 'internet.freedommobile.ca',
                                             'name': 'Internet',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'mms.freedommobile.ca',
             ...
             {'@code': 'ch',
              'emergency-numbers': {'emergency-number': [{'@number': '114',
                                                          'callee': {'@type': 'ambulance'}},
                                                         {'@number': '117',
                                                          'callee': {'@type': 'police'}},
                                                         {'@number': '118',
              ...
              'name': 'Switzerland',
              'provider': [{'gsm': {'apn': {'@value': 'data.lycamobile.ch',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmch'},
              ...
              'provider': [{'gsm': {'apn': {'@value': 'internet',
                           ...
                           {'@primary': 'false',
                            'gsm': {'apn': {'@value': 'internet.t-mobile.cz',
                                            ...
                                            'usage': {'@type': 'internet'},
                                            'username': 'gprs'},
                                    'balance-check': {'ussd': '*146#'},
                                    'balance-top-up': {'ussd': {'#text': '*144*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '230',
                                                   '@mnc': '01'}},
                            'name': 'MOBIL.CZ'}]},
             {'@code': 'de',
              'cbs': {'level': [{'@type': 'presidential',
                                 'channels': [{'@end': '4370',
                                               '@start': '4370'},
                                              {'@end': '4383',
                                               '@start': '4383'},
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'internet.eplus.de',
                            ...
                            'gsm': {'apn': {'@value': 'internet.eplus.de',
                                    ...
                                    'network-id': [{'@mcc': '262',
                                                   ...
                                                   {'@mcc': '262',
                                                    '@mnc': '77'}]},
                            'name': 'E-Plus'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.de',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmde'},
                           ...
                           {'gsm': {'apn': [{'@value': 'internet.t-d1.de',
                                            ...
                                            {'@value': 'internet.t-mobile',
                                             ...
                                             'name': 'Dualstack with MMS and '
                                                     'fixed DNSv4',
                                             'password': 'tm',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'},
                                             'username': 't-mobile'},
                                            {'@value': 'internet.v6.telekom',
                                             'name': 'IPv6-only',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                           ...
                           {'gsm': {'apn': [{'@value': 'internet.telekom',
                                             'dns': ['193.254.160.1',
                                                     '10.74.83.22'],
                                             ...
                                             'username': 'congstar'},
                                            {'@value': 'internet.telekom',
                                             'mmsc': 'https://www.mms.telekon.de/OTP/',
                                             'mmsproxy': '109.231.176.193:8008',
                                             'name': 'Congstar MMS',
                                             'password': 'telekom',
                                             'plan': {'@type': 'prepaid'},
                                             'usage': {'@type': 'mms'},
              ...
              'provider': [{'@primary': 'true',
                           ...
                           {'gsm': {'apn': [{'@value': 'bredband.oister.dk',
                                    ...
                                    'network-id': {'@mcc': '238',
                                                   '@mnc': '06'}},
                            'name': 'OiSTER'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.dk',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmdk'},
                                    ...
                                    'network-id': {'@mcc': '238',
                                                   '@mnc': '12'}},
                            'name': 'Lycamobile'},
                           {'cdma': {'password': 'cdma', 'username': 'cdma'},
             ...
             {'@code': 'es',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'internet.euskaltel.mobi',
                                             ...
                                             'usage': {'@type': 'internet'},
                                             'username': 'CLIENTE'},
                                            {'@value': 'euskaltelmms.euskaltel.mobi',
                           ...
                           {'gsm': {'apn': {'@value': 'lowi.private.omv.es',
                                            ...
                                            'usage': {'@type': 'internet'}}},
                            'name': 'Lowi'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.es',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmes'},
                                    'balance-check': {'ussd': '*221#'},
                                    'balance-top-up': {'ussd': {'#text': '*221*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '214',
                                                   '@mnc': '25'}},
                            'name': 'Lycamobile'},
             ...
             {'@code': 'fi',
              ...
              'provider': [{'gsm': {'apn': {'@value': 'kuirinet',
                            ...
                            'name': 'Kuiri'},
                           {'gsm': {'apn': [{'@value': 'internet',
                                             'name': 'Postpaid (contract) NAT '
                                                     '(available for all '
                                                     'subscribers)',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'julkinen.dna.fi',
                                             'name': 'Postpaid (contract) '
                                                     'public IP address (Dec '
                                                     '2016 and later '
                                                     'individual '
                                                     'subscriptions)',
                                             'plan': {'@type': 'postpaid'},
                                            ...
                                            {'@value': 'data.dna.fi',
                                             'name': 'Postpaid (contract) '
                                                     'public IP address (Nov '
                                                     '2016 and earlier '
                                                     'individual, and all '
                                                     'company subscriptions)',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'data.moimobile.fi',
                                             'name': 'Moi Mobiili',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'mms',
                           ...
                           {'gsm': {'apn': [{'@value': 'internet',
                                            ...
                                            {'@value': 'opengate',
                                             'dns': ['192.89.123.230',
                                                     '192.89.123.231'],
                                             'name': 'Open Gate (public IP, '
                                                     'open ports; needs to be '
                                                     'ordered)',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'prointernet',
              ...
              'provider': [{'gsm': {'apn': {'@value': 'wap65',
                           ...
                           {'gsm': {'apn': [{'@value': 'free',
                                            ...
                                            {'@value': 'mmsfree',
                                             ...
                                             'name': 'MMS Free',
                                             'usage': {'@type': 'mms'}}],
                                    'balance-check': {'sms': {'#text': '555',
                                                              '@text': 'conso'}},
                                    'network-id': {'@mcc': '208', '@mnc': '15'},
                                    'visual-voicemail': {'carrier-prefix': '//VVM',
                                                         'destination-number': '2050',
                                                         'standard': {'@type': 'ios'}},
                                    'voicemail': '666'},
                            'name': 'Free Mobile'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.fr',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmfr'},
             ...
             {'@code': 'gb',
              ...
              'provider': [{'gsm': {'apn': {'@value': 'btmobile.bt.com',
                                    ...
                                    'network-id': {'@mcc': '234',
                                                   '@mnc': '00'}},
                            'name': 'BT Mobile'},
                           {'gsm': {'apn': {'@value': 'uk.lebara.mobi',
                                            'mmsattachmentsize': '306200',
                           ...
                           {'gsm': {'apn': [{'@value': 'everywhere',
                                    ...
                                    'voicemail': '222'},
                            'name': 'EE'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.co.uk',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmuk'},
             ...
             {'@code': 'gn',
              'name': 'Guinea',
              'provider': [{'gsm': {'apn': {'@value': 'internetogn',
                                            'plan': {'@type': 'postpaid'},
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '611',
                                                   '@mnc': '01'}},
                            'name': 'Orange'},
                           {'gsm': {'apn': {'@value': 'internet.cellcom.com',
                                            'password': 'cellcom',
                                            'plan': {'@type': 'postpaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'internet'},
                           ...
                           {'gsm': {'apn': [{'@value': 'mobile.three.com.hk',
                                    ...
                                    'network-id': [{'@mcc': '454',
                                                   ...
                                                   {'@mcc': '454',
                                                    '@mnc': '04'}]},
                            'name': '3'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.hk',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmhk'},
             ...
             {'@code': 'ie',
              'name': 'Ireland',
              'provider': [{'gsm': {'apn': {'@value': 'data.lycamobile.ie',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmie'},
             ...
             {'@code': 'in',
              'name': 'India',
              'provider': [{'gsm': {'apn': {'@value': 'airtelgprs.com',
                                            'dns': ['202.56.230.5',
                                                    '202.56.240.5'],
                                            'plan': {'@type': 'postpaid'},
                                            'usage': {'@type': 'internet'}},
                           ...
                           {'gsm': {'apn': [{'@value': 'mtnl.net',
                                             'name': 'Delhi (3G Prepaid / '
                                                     'Postpaid)',
                                             'password': 'mtnl123',
                                             'usage': {'@type': 'internet'},
                                             'username': 'mtnl'},
                                            {'@value': 'mtnl.net',
                                             'name': 'Mumbai (3G Prepaid / '
                                                     'Postpaid)',
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'gprsmtnldel',
                                             'name': 'Delhi',
             ...
             {'@code': 'iq',
              ...
              'provider': [{'cdma': {'password': 'itisaluna',
                                     ...
                                     'username': 'itisaluna'},
                            'name': 'Itisaluna'},
                           {'cdma': {'password': 'omnea', 'username': 'omnea'},
                            'name': 'Omnea Telecom'},
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'mobile.vodafone.it',
                           ...
                           {'gsm': {'apn': {'@value': 'tiscalimobileinternet',
                                    ...
                                    'network-id': {'@mcc': '222',
                                                   '@mnc': '01'}},
                            'name': 'Tiscali'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.it',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmit'},
                           ...
                           {'gsm': {'apn': [{'@value': 'iliad',
                                            ...
                                            {'@value': 'mms.iliad.it',
                                             ...
                                             'name': 'Iliad MMS',
                                             'usage': {'@type': 'mms'}}],
                                    'balance-check': {'sms': {'#text': '400',
                                                              '@text': 'Credito'}},
                                    'network-id': {'@mcc': '222', '@mnc': '50'},
                                    'visual-voicemail': {'carrier-prefix': '//VVM',
                                                         'destination-number': '2050',
                                                         'standard': {'@type': 'ios'}},
                                    'voicemail': '401'},
             ...
             {'@code': 'jo',
              ...
              'provider': [{'gsm': {'apn': {'@value': 'net.orange.jo',
                           ...
                           {'gsm': {'apn': [{'@value': 'zain',
                            ...
                            'name': 'Zain'}]},
             {'@code': 'jp',
              'emergency-numbers': {'emergency-number': [{'@number': '119',
                                                          'callee': [{'@type': 'ambulance'},
                                                                     {'@type': 'fire-brigade'}]},
                                                         {'@number': '110',
                                                          'callee': {'@type': 'police'}}]},
                            ...
                            'gsm': {'apn': {'@value': 'rakuten.jp',
                                    ...
                                    'network-id': [{'@mcc': '440',
                                                   ...
                                                   {'@mcc': '440',
                                                    '@mnc': '53'}]},
                            'name': '楽天モバイル'},
                           {'gsm': {'apn': [{'@value': '3g-d-2.ocn.ne.jp',
             ...
             {'@code': 'kr',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'alwayson.ktfwing.com',
                                             'name': 'KT 3G',
                                             'usage': {'@type': 'internet'}},
                           ...
                           {'cdma': {'username': 'sktelecom'},
                            'gsm': {'apn': [{'@value': 'web.sktelecom.com',
                                             'name': 'SKT 3G',
                                             'usage': {'@type': 'internet'}},
             ...
             {'@code': 'li',
              'name': 'Liechtenstein',
              'provider': {'gsm': {'apn': {'@value': 'datamobile.ag',
                                           'plan': {'@type': 'postpaid'},
                                           'usage': {'@type': 'internet'}},
                                   'network-id': {'@mcc': '295', '@mnc': '05'}},
                           'name': 'Datamobile'}},
             {'@code': 'lc',
              'name': 'St Lucia',
              'provider': {'gsm': {'apn': [{'@value': 'internet',
              ...
              'provider': [{'gsm': {'apn': {'@value': 'internet',
                           ...
                           {'gsm': {'apn': {'@value': 'vipoperator',
                                    ...
                                    'network-id': {'@mcc': '294',
                                                   '@mnc': '03'}},
                            'name': 'Vodafone'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.mk',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmde'},
                                    'balance-check': {'ussd': '*122#'},
                                    'balance-top-up': {'ussd': {'#text': '*122*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '294',
                                                   '@mnc': '04'}},
                            'name': 'Lycamobile'}]},
             {'@code': 'mt',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'gosurfing',
                                    ...
                                    'network-id': {'@mcc': '278',
                                                   '@mnc': '21'}},
                            'name': 'GO Mobile'},
                           {'gsm': {'apn': {'@value': 'web.melita',
                                            'name': 'Melita Connector',
                                            'plan': {'@type': 'postpaid'},
                                            'usage': {'@type': 'internet'}},
                                    'balance-check': {'sms': {'#text': '16877',
                                                              '@text': 'melita'}},
                                    'network-id': {'@mcc': '278',
                                                   '@mnc': '77'}},
                            'name': 'Melita'},
             ...
             {'@code': 'mw',
              ...
              'provider': [{'gsm': {'apn': {'@value': 'internet',
                                            ...
                                            'plan': [{'@type': 'prepaid'},
                                                     {'@type': 'postpaid'}],
                                            'usage': {'@type': 'internet'}},
                                    'balance-check': {'ussd': '*137#'},
                                    'balance-top-up': {'ussd': {'#text': '*136*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '650',
                                                   '@mnc': '10'}},
                            'name': 'Airtel MW'},
             ...
             {'@code': 'na',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'ppsinternet',
                                    ...
                                    'network-id': {'@mcc': '649',
                                                   '@mnc': '01'}},
                            'name': 'MTC'},
                           {'cdma': {'name': 'switch', 'password': 'telecom'},
                            'name': 'Telecom'},
                           {'gsm': {'apn': [{'@value': 'internet',
                                             'name': 'Leo',
                                             'plan': {'@type': 'postpaid'},
                           ...
                           {'@primary': 'true',
                            'gsm': {'apn': [{'@value': 'internet',
                                            ...
                                            {'@value': 'mms',
                                             ...
                                             'usage': {'@type': 'mms'},
                                             'username': 'tmobilemms'}],
                                    'balance-check': {'sms': {'#text': '1144',
                                                              '@text': 'SALDO'}},
                                    'network-id': {'@mcc': '204',
                                                   '@mnc': '16'}},
                            'name': 'T-Mobile'},
                           {'gsm': {'apn': [{'@value': 'basic.internet.ben.data',
                                             'dns': ['193.78.240.12',
                                                     '193.79.242.39'],
                                    ...
                                    'network-id': {'@mcc': '204',
                                                   '@mnc': '16'}},
                            'name': 'Ben'},
                           {'gsm': {'apn': {'@value': 'internet.access.nl',
                                            'name': 'Simpel',
                                            'plan': {'@type': 'postpaid'},
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '204',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'internet.netcom.no',
                           ...
                           {'gsm': {'apn': {'@value': 'internet.phonero.no',
                                    ...
                                    'network-id': {'@mcc': '242',
                                                   '@mnc': '01'}},
                            'name': 'Phonero'},
                           {'gsm': {'apn': {'@value': 'data.lyca-mobile.no',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmno'},
                                    'balance-check': {'ussd': '*150#'},
                                    'balance-top-up': {'ussd': {'#text': '*150*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '242',
                                                   '@mnc': '23'}},
                            'name': 'Lycamobile'}]},
             ...
             {'@code': 'pk',
              'name': 'Pakistan',
              'provider': [{'gsm': {'apn': [{'@value': 'connect.mobilinkworld.com',
                                             'name': 'Internet',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
             ...
             {'@code': 'pl',
              ...
              'provider': [{'@primary': 'true',
                           ...
                           {'@primary': 'false',
                            'cdma': {'password': 'CDMA', 'username': 'CDMA'},
                            'name': 'Nordisk Polska'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.pl',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmpl'},
             ...
             {'@code': 'pt',
              'name': 'Portugal',
              'provider': [{'gsm': {'apn': [{'@value': 'utms',
                                             'name': 'NOS / WTF Pós-Pago '
                                                     '(internet)',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'utms',
                                             'name': 'NOS / WTF Pré-Pago '
                                                     '(internet)',
                                             'plan': {'@type': 'prepaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'myconnection',
                                             'name': 'NOS Kanguru Net Móvel '
                                                     '(internet)',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'umts',
                                    ...
                                    'voicemail': '133'},
                            'name': 'NOS'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.pt',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmpt'},
                           ...
                           {'gsm': {'apn': [{'@value': 'internet.vodafone.pt',
                                            ...
                                            {'@value': 'net2.vodafone.pt',
                                             ...
                                             'mmsproxy': 'iproxy.vodafone.pt:80',
                                             'name': 'Vodafone / Yorn (MMS)',
                                             'password': 'vodafone',
                                             'usage': {'@type': 'mms'},
                                             'username': 'vodafone'}],
                                    'balance-check': {'ussd': '*#123#'},
             ...
             {'@code': 'ro',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'net',
                           ...
                           {'gsm': {'apn': {'@value': 'live.vodafone.com',
                                            ...
                                            'username': 'live'}},
                            'name': 'Vodafone'},
                           {'cdma': {'password': 'zapp', 'username': 'zapp'},
                            'name': 'Zapp'},
                           {'gsm': {'apn': [{'@value': 'internet',
                                             'name': 'Home',
                                             'plan': {'@type': 'postpaid'},
                                    ...
                                    'network-id': {'@mcc': '226',
                                                   '@mnc': '05'}},
                            'name': 'Digi.Net Mobil'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.ro',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmro'},
             ...
             {'@code': 'ru',
              'name': 'Russia',
              'provider': [{'gsm': {'apn': [{'@value': 'home.beeline.ru',
                                             'dns': ['212.44.130.6',
                                                     '217.118.83.6'],
                                             'name': ['3G modem',
                                                      {'#text': 'USB-модем',
                           ...
                           {'gsm': {'apn': {'@value': 'gpb',
                            ...
                            'name': ['Gazprombank Mobile',
                                     {'#text': 'Газпромбанк Мобайл',
                                      '@{http://www.w3.org/XML/1998/namespace}lang': 'ru'}]},
                           {'gsm': {'apn': {'@value': 'internet.letai.ru',
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '250',
                                                   '@mnc': '27'}},
                            'name': ['Letai',
                           ...
                           {'gsm': {'apn': {'@value': 'internet',
                            ...
                            'name': ['Phoenix',
                                     {'#text': 'Феникс',
                                      '@{http://www.w3.org/XML/1998/namespace}lang': 'ru'}]},
                           {'gsm': {'apn': {'@value': 'internet.sberbank-tele.com',
                           ...
                           {'cdma': {'password': 'internet',
                            ...
                            'name': ['Skylink',
                                     {'#text': 'Скайлинк',
                                      '@{http://www.w3.org/XML/1998/namespace}lang': 'ru'}]},
                           {'gsm': {'apn': {'@value': 'm.tinkoff',
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '250',
                                                   '@mnc': '62'}},
                            'name': ['Tinkoff Mobile',
                                     {'#text': 'Тинькофф Мобайл',
                                      '@{http://www.w3.org/XML/1998/namespace}lang': 'ru'}]},
                           {'gsm': {'apn': {'@value': 'vtk',
                                            'name': 'vtk',
                                            'usage': {'@type': 'internet'}},
                           ...
                           {'gsm': {'apn': {'@value': 'bredband.comhem.se',
                                    ...
                                    'network-id': [{'@mcc': '240',
                                                   ...
                                                   {'@mcc': '240',
                                                    '@mnc': '04'}]},
                            'name': 'Com Hem'},
                           {'gsm': {'apn': {'@value': 'data.lycamobile.se',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmse'},
             ...
             {'@code': 'tn',
              ...
              'provider': [{'gsm': {'apn': [{'@value': 'weborange',
                           ...
                           {'gsm': {'apn': {'@value': 'data.lycamobile.tn',
                                            'password': 'plus',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'},
                                            'username': 'lmtn'},
                                    'balance-check': {'ussd': '*143#'},
                                    'balance-top-up': {'ussd': {'#text': '*143*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '605',
                                                   '@mnc': '02'}},
                            'name': 'Lycamobile'},
              ...
              'provider': [{'gsm': {'apn': {'@value': 'yellopix.mtn.co.ug',
                           ...
                           {'gsm': {'apn': {'@value': 'internet ',
                            ...
                            'name': ['+7Telecom',
                                     {'#text': '+7Телеком',
                                      '@{http://www.w3.org/XML/1998/namespace}lang': 'ru'}]},
                           {'gsm': {'apn': {'@value': 'internet.ktkru.ru',
                                            'name': 'KTK',
                                            'usage': {'@type': 'internet'}},
                                    'network-id': {'@mcc': '250',
                                                   '@mnc': '34'}},
             ...
             {'@code': 'us',
              'cbs': {'level': [{'@type': 'presidential',
                                ...
                                {'@type': 'amber',
                                 'channels': {'@end': '4379',
                                              '@start': '4379'}}]},
              'emergency-numbers': {'emergency-number': {'@number': '911',
                                                         'callee': [{'@type': 'police'},
                                                                    {'@type': 'ambulance'},
                                                                    {'@type': 'fire-brigade'}]}},
              'name': 'United States',
              'provider': [{'gsm': {'apn': [{'@value': 'NXTGENPHONE',
                                             'gateway': 'proxy.mobile.att.net:80',
                                             'mmsc': 'http://mmsc.mobile.att.net',
                                             'mmsproxy': 'proxy.mobile.att.net:80',
                                             'name': 'NXTGENPHONE',
                                             'usage': {'@type': 'mms-internet-hipri'}},
                                            {'@value': 'ENHANCEDPHONE',
                                             'mmsc': 'http://mmsc.mobile.att.net',
                                             'mmsproxy': 'proxy.mobile.att.net:80',
                                             'name': 'ENHANCEDPHONE',
                                            ...
                                            {'@value': 'NRPHONE',
                                             'name': 'NRPHONE',
                                             'usage': {'@type': 'mms-internet-hipri-fota'}},
                                            {'@value': 'broadband',
                                             'name': 'ATT Broadband',
                                             'usage': {'@type': 'mms-internet-hipri-fota'}},
                                            {'@value': 'RESELLER',
                                    ...
                                    'network-id': [{'@mcc': '310',
                                                   ...
                                                   {'@mcc': '310',
                                                    '@mnc': '680'}],
                                    'visual-voicemail': {'carrier-prefix': '//VVM',
                                                         'destination-number': '94183567',
                                                         'standard': {'@type': 'ios'}},
                                    'voicemail': '+17249209990'},
                            'name': 'AT&T'},
                           {'@primary': 'true',
                           ...
                           {'gsm': {'apn': [{'@value': 'firstnet-phone',
                                             'gateway': 'proxy.mobile.att.net:80',
                                             'mmsc': 'http://mmsc.mobile.att.net',
                                             'mmsproxy': 'proxy.mobile.att.net:80',
                                             'name': 'firstnet-phone',
                                             'usage': {'@type': 'mms-internet-hipri'}},
                                            {'@value': 'firstnet-broadband',
                                             'name': 'firstnet-broadband',
                                             'usage': {'@type': 'mms-internet-hipri'}}],
                                    'network-id': [{'@mcc': '312',
                                                    '@mnc': '670'},
                                                   {'@mcc': '313',
                           ...
                           {'cdma': {'sid': [{'@value': '2'},
                            ...
                            'gsm': {'apn': [{'@value': 'vzwims',
                                    ...
                                    'network-id': [{'@mcc': '310',
                                                   ...
                                                   {'@mcc': '311',
                                                    '@mnc': '489'}],
                                    'visual-voicemail': {'carrier-prefix': '//VZWVVM',
                                                         'destination-number': '900080006200',
                                                         'standard': {'@type': 'vvm3'}}},
                            'name': 'Verizon'},
                           {'cdma': {'sid': [{'@value': '5'},
                                             {'@value': '104'},
                           ...
                           {'cdma': {'sid': [{'@value': '32'},
                            ...
                            'gsm': {'apn': [{'@value': 'MMS',
                                    ...
                                    'network-id': {'@mcc': '310',
                                                   '@mnc': '590'}},
                            'name': 'Alltel'},
                           {'gsm': {'apn': [{'@value': 'wireless.dish.com',
                                             'name': 'Ting Data',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}},
                                            {'@value': 'wireless.dish.com',
                                             'mmsc': 'http://wholesale.mmsmvno.com/mms/wapenc',
                                             'name': 'MMS',
                                             'usage': {'@type': 'mms'}},
                                            {'@value': 'tethering.dish.com',
                                             'name': 'Ting Data',
                                             'plan': {'@type': 'postpaid'},
                                             'usage': {'@type': 'internet'}}],
                                    'network-id': {'@mcc': '310',
                           ...
                           {'gsm': {'apn': {'@value': 'data.lycamobile.com',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'}},
                                    'balance-check': {'ussd': '*611#'},
                                    'balance-top-up': {'ussd': {'#text': '*611*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'network-id': {'@mcc': '311',
                                                   '@mnc': '960'}},
                            'name': 'Lycamobile'},
             ...
             {'@code': 'sz',
              'name': 'Eswatini',
              'provider': [{'gsm': {'apn': {'@value': 'mymtn.co.sz',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'}},
                                    'balance-check': {'ussd': '*556#'},
                                    'balance-top-up': {'ussd': {'#text': '*555*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'msisdn-query': {'ussd': '*123#'},
                                    'network-id': {'@mcc': '653',
                                                   '@mnc': '10'}},
                            'name': 'MTN Eswatini'},
                           {'gsm': {'apn': {'@value': 'internet',
                                            'plan': {'@type': 'prepaid'},
                                            'usage': {'@type': 'internet'}},
                                    'balance-check': {'ussd': '*202#'},
                                    'balance-top-up': {'ussd': {'#text': '*200*CODE#',
                                                                '@replacement': 'CODE'}},
                                    'msisdn-query': {'ussd': '*123#'},
                                    'network-id': {'@mcc': '653',
                                                   '@mnc': '02'}},
             ...
             {'@code': 'xk',
              'name': 'Kosovo',
              'provider': {'gsm': {'apn': {'@value': 'ipko',
                                           'name': 'ipko',
                                           'plan': {'@type': 'prepaid'},
                                           'usage': {'@type': 'internet'}},
                                   'network-id': {'@mcc': '221', '@mnc': '02'}},
                           'name': 'IPKO'}}]}
